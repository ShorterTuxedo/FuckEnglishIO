...
cBm={"0":"The work does not reach a standard described by the descriptors below.","1":"The oral is descriptive or contains no relevant analysis. Authorial choices are seldom identified and, if so, are poorly understood in relation to the presentation of the global issue.","3":"The oral contains some relevant analysis, but it is reliant on description. Authorial choices are identified, but are vaguely treated and/or only partially understood in relation to the presentation of the global issue.","5":"The oral is analytical in nature, and evaluation of the extracts and their works/texts is mostly relevant. Authorial choices are identified and reasonably understood in relation to the presentation of the global issue. ","7":"Analysis and evaluation of the extracts and their works/texts are relevant and at times insightful. There is a good understanding of how authorial choices are used to present the global issue.","9":"Analysis and evaluation of the extracts and their works/texts are relevant and insightful. There is a thorough and nuanced understanding of how authorial choices are used to present the global issue."}
